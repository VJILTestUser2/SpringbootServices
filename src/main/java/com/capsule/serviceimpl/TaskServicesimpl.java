...
import com.capsule.springboot.ParentRepository;
...
public class TaskServicesimpl {
	...
	@Autowired
	ParentRepository ptaskRepository;
	...
	public ParentTask addParentTasks(ParentTask ctask) {
		
		return ptaskRepository.save(ctask);
	}
